...
setup(
    name='mdharvest',
    version=get_version('mdharvester.py'),
    description='A ChRIS plugin to do collect DICOM meta data',
    author='FNNDSC',
    author_email='dev@babyMRI.org',
    url='https://github.com/FNNDSC/pl-mdharvest',
    py_modules=['mdharvester'],
    install_requires=['chris_plugin'],
    license='MIT',
    entry_points={
        'console_scripts': [
            'mdharvester = mdharvester:main'
        ]
    },
    classifiers=[
