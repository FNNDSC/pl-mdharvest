...
LABEL org.opencontainers.image.authors="FNNDSC <dev@babyMRI.org>" \
      org.opencontainers.image.title="Metadata Harvester" \
      org.opencontainers.image.description="A ChRIS plugin to do collect DICOM meta data"

ARG SRCDIR=/usr/local/src/pl-mdharvest
WORKDIR ${SRCDIR}
